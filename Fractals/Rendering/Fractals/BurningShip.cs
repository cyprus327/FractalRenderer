...
internal sealed class BurningShip : Fractal {
    public BurningShip(int width, int height, bool showLogs = false) {
        Initialize(Shaders.BurningShipFragCode, out int handle, showLogs, true);
        Handle = handle;
